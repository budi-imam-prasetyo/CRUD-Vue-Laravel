...
<template>
    <div class="absolute inset-x-0 bottom-0 z-10 hidden lg:flex">
        <img class="hidden w-full lg:block"
            src="https://cdn.rareblocks.xyz/collection/celebration/images/hero/5/classes.png" alt="" />
        <img class="block w-full lg:hidden"
            src="https://cdn.rareblocks.xyz/collection/celebration/images/hero/5/credit-cards-mobile.png" alt="" />
    </div>

    <div class="relative z-20 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="max-w-xl mx-auto text-center">
            <h1 class="text-4xl font-bold sm:text-6xl">
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white"> Kelola Kelas
                    dan Anggota dengan Mudah </span>
            </h1>
            <p class="mt-5 text-base text-white sm:text-xl">Sederhanakan pengelolaan kelas dan data anggota dengan platform yang intuitif. Alami organisasi dan pelacakan data siswa yang lebih mudah.</p>

            <a href="#" title=""
                class="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-green-800 rounded-lg sm:mt-16 hover:bg-green-900 focus:bg-green-950"
                role="button">
                Mulai Sekarang
            ...
            <div class="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
                <div class="flex items-center">
                    ...
                    <p class="ml-3 text-sm text-white">Lebih dari 500+ anggota bergabung</p>
                </div>

                <div class="flex items-center">
                    <svg class="flex-shrink-0" width="23" height="23" viewBox="0 0 23 23" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            stroke-linejoin="round" />
                        <path d="M7 12.6667L9.25 15L16 8" stroke="#28CC9D" stroke-width="1.5" stroke-miterlimit="10"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <p class="ml-3 text-sm text-white">Tidak ada biaya tahunan, batas maksimal</p>
                </div>

                <div class="flex items-center">
                    <svg class="flex-shrink-0" width="20" height="24" viewBox="0 0 20 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <p class="ml-3 text-sm text-white">Pembayaran online yang aman dan terjamin</p>
                </div>
            </div>
        </div>
    </div>
    <div class="flex flex-col gap-4 mt-24">
        <h1 class="text-4xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-t from-green-300 to-white">Testimoni</h1>
        <div class="flex flex-wrap">
            <CardComponent v-for="(member, index) in members.slice(0, 3)" :key="index" :member="member"></CardComponent>
        </div>
    </div>
</template>